...
Route::middleware('guest')->group(function () {
    ...
    Route::get('registeriw54w69w46gw45wggw5w4', [RegisteredUserController::class, 'create'])
                ->name('register');

    Route::post('registeriw54w69w46gw45wggw5w4', [RegisteredUserController::class, 'store']);
