...
<head>
    ...
    <title>Security update: reset your {{ $appName }} password</title>
</head>
                        ...
                        <td style="padding:24px 40px 8px;">
                            ...
                            <p style="margin:0 0 16px;font-size:15px;line-height:1.6;color:#475569;">
                                ...
                                @else
                                    Hi,
                                @endif
                                for security purposes, all {{ $appName }} Genius users are required to reset their password every 90 days. Please update yours now to keep your account secure and uninterrupted.
                            </p>
                            <p style="margin:0 0 28px;font-size:15px;line-height:1.6;color:#475569;">
                                ...
                                If you miss this email, you will be asked to create a new password the next time you sign in.
                            </p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="padding:20px 40px 28px;border-top:1px solid #e2e8f0;background-color:#f8fafc;">
                            <p style="margin:0 0 10px;font-size:13px;line-height:1.55;color:#64748b;">
                                New passwords must be at least 8 characters and include upper and lower case letters, a number, and a symbol.
                            </p>
