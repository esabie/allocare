                                ...
                                {showByPatient && (
                                    <div className="mt-4">
                                        <select
                                            ...
                                            className="w-full rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm sm:w-auto"
                                        >
                                        ...
                                        {selectedPatient ? (
                                            <div className="mt-3 inline-flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
                                            ...
                                            <p className="mt-3 text-xs text-slate-500">Select a patient to see their incident count.</p>
                                        )}
                                    </div>
                                )}
                            </section>
